...
class BoardButton(discord.ui.Button):
    ...
    async def callback(self, interaction: discord.Interaction):
        ...
        view.turn += 1
        string = (
            f"**{view.player1.name if view.turn % 2 == 0 else view.player2.name}** has placed at {self.label}\n"
        )
        ...
        await interaction.response.edit_message(
            content=f"{view.player1.mention if view.turn % 2 == 1 else view.player2.mention}",
    ...
    async def check_turn(self, interaction):
        ...
        if interaction.user != view.player1 and interaction.user != view.player2:
            ...
            (view.turn % 2 == 1 and interaction.user != view.player1) or
            (view.turn % 2 == 0 and interaction.user != view.player2)
        ):
